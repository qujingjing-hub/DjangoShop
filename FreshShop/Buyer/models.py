...
class Address(models.Model):
    """
       收货地址
    """
    address = models.TextField(verbose_name="收货地址",null=True,blank=True)
    receive = models.CharField(max_length=32,verbose_name="收件人")
    receive_phone = models.CharField(max_length=32,verbose_name="收件人电话")
...
class Order(models.Model):
    ...
    order_user = models.ForeignKey(to=Buyer,on_delete=models.CASCADE,verbose_name="订单编号（多对一）")
